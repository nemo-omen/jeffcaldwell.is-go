...
func Index(posts []*model.Post, projects []*model.Project) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<section class=\"post-list-section layout-container page\"><div class=\"intro text-large\" style=\"margin-block: var(--space-m);\"><p style=\"margin-bottom: var(--space-s);\">I'm Jeff Caldwell, a web developer who loves working on both sides of the stack. This is my personal site, where you can read my latest <a href=\"/blog\">thoughts</a>, learn about <a href=\"/projects\">my projects</a>, or find out more <a href=\"/about\">about me</a>.</p><p>This site is my evolving personal space on the web. It's part blog, part experimentation space, and part portfolio. You can see what I'm planning to do for the site at the <a href=\"/todo\">todo list</a>.</p></div><div class=\"section-header highlight\"><h2>Recent Projects</h2></div><div class=\"project-list auto-grid\">")
		...
		templ_7745c5c3_Err = layout.Base("Jeff Caldwell's new page").Render(templ.WithChildren(ctx, templ_7745c5c3_Var2), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
